...
public class DisplayFarm2 implements GLEventListener
{
	...
	private boolean onlyLand = false;
	
	public void setWaterView(boolean b)
	{
		this.onlyWater = b;
		this.onlyLand = !b;
	}
	
	public void setLandView(boolean b)
	{
		this.onlyLand = b;
		this.onlyWater = !b;
	}
	
	public void setToggleView()
	{
		this.onlyLand = false;
	...
	private void makeCube(GL2 gl, int x, int y, int z, double cell_width_height, double cell_depth)
	{
		...
		if(this.onlyLand == false && this.onlyWater == false)
		{
		...
		if(this.onlyLand == true && this.onlyWater == false)
		{
		Color cellColor = this.getColor(this.grid[x][y][z]);
		gl.glColor3d(cellColor.red, cellColor.green, cellColor.blue);
		}
		
		if(this.onlyLand == false && this.onlyWater == true)
		{
		Double blueness = this.grid[x][y][z].getWater();
		
		gl.glColor3d(0, 0, this.grid[x][y][z].getWater());
		}
